...
def parse_commandline():
    ...
    parser.add_option("-f","--filters",default="V,R,F606W,I,F814W")
...
if opts.doLightcurves:
    system_command = "python run_lightcurves_models.py --doEvent --model %s --name GRB060614 --tmin 0.0 --tmax 10.0 --distance 589.1 --T0 53900.52986111 --filters %s --errorbudget %.2f %s %s %s"%(opts.model,opts.filters,opts.errorbudget,eosfitFlag,fixzpt0Flag,typeFlag)
