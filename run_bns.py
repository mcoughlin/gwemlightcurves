...
def parse_commandline():
    ...
    parser.add_option("-m","--model",default="BNS")
    parser.add_option("-e","--eos",default="H4")
    parser.add_option("-q","--m1",default=1.35,type=float)
    parser.add_option("-a","--m2",default=1.35,type=float) 
...
#filename = '%s/%s.txt'%(outputDir,name)
#fid = open(filename,'w')
